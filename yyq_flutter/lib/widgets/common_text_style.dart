...
final ft16Black16TS = TextStyle(color: Colors.black12,fontSize: ScreenUtil().setSp(16),);

final bold16TextStye = TextStyle(color: Colors.black,fontSize: ScreenUtil().setSp(16),fontWeight: FontWeight.bold);
final bold20TextStye = TextStyle(color: Colors.black,fontSize: ScreenUtil().setSp(20),fontWeight: FontWeight.bold);
final bold24TextStye = TextStyle(color: Colors.black,fontSize: ScreenUtil().setSp(24),fontWeight: FontWeight.bold);
